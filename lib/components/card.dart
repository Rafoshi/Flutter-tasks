...
class _TaskCardState extends State<TaskCard> {
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        DownPartCard(nivel),
        UpperPartCard(widget.nome),
      ],
    );
  }
}

class DownPartCard extends StatelessWidget {
  final int nivel;
  const DownPartCard(this.nivel, {super.key});
...
class UpperPartCard extends StatelessWidget {
  final String nome;
  const UpperPartCard(this.nome, {super.key});
